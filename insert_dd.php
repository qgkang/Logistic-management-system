...
<table  class="ziti" width="687" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#666666">
  <tr>
	...
	<iframe name="content" src="insert_dds.php?ljid=<?php echo $_GET['ljid'];?>"  frameborder="0" width="97%" height="252%"></iframe></td>
    </tr>
  <tr>
...
content.form5.submit()
      ...
      &nbsp;&nbsp;
<a href="#" onClick="parent.content.focus();window.print();">
